        ...
        <div className='bg-white w-full border rounded-md border-gray-200 p-4 shadow'> 
            ...
            <div className='bg-white w-full border h-50 mt-4 mb-4 rounded-md border-gray-200 p-4 pb-2 shadow'>
              ...
              <form onSubmit={handlePost}>
                ...
                <input type="text-area" id="description" name="comment" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mb-2" placeholder={"Please provide comments if necessary."} required />
