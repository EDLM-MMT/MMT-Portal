    ...
    return (
        ...
        <form className='flex flex-col mt-4 items-center' onSubmit={handleSubmit} onChange={handleUpdate}>
            ...
            <div className='flex flex-row items-center justify-between w-1/3 mt-2'>
                ...
                <button onClick={handleSubmit} type="submit" class="text-white bg-blue-700 hover:bg-blue-800 h-10 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Reset Password</button>
            </div>
        </form>
