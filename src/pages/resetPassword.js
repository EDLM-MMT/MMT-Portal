...
export default function ResetPassword() {
    ...
    return (
        ...
        <form className='mt-4' onSubmit={handleSubmit} onChange={handleUpdate}>
            <div class="grid gap-6 mb-6 w-1/3">
                ...
                <div>
                    ...
                    <input type="password" name="retypePassword" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
                </div>
            </div>

            <div className='flex flex-row items-center justify-between w-1/3'>
                <Button btnText={"Cancel"} link={"/dashboard"} className={"ml-0"}></Button>
