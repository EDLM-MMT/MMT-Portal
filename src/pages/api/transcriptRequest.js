import transcriptRequest from '@/data/service_member/transcriptRequestData.json';
import fsPromises from 'fs/promises';
import path from 'path';

const dataFilePath = path.join(process.cwd(), 'src/data/service_member/transcriptRequestData.json');

export default async function handler(req, res) {
   // console.log("req body:", req.body)
    if(req.method === 'GET'){
        // console.log("here", careerCounseling);
        return res.status(200).json(transcriptRequest);
        ...
        try {
           ...
           // console.log("jsondata:", jsonData)
            ...
            objectData.transcriptRequest.push(newData.body);
