...
export default function ProgramAdminViewCard({ account , routePath, className}){
                    ...
                    <p className="mt-6">
                        <div className="flex flex-row">
                            ...
                            <div className="flex-col">
                                ...
                                {isOpen && <GeneralPurposeOverlay toggleModal={setIsOpen} path={`/programAdmin/accountsManagement/${routePath}`}
